...
class MenusController extends AdminController
{
    ...
    public function create()
    {
        ...
        $this->content = view(env('THEME').'.admin.menus_create_content')->with(['menus' => $menus, 'categories'=>$list, 'filters'=> $filters, 'portfolios' => $portfolios, 'articles' => $articles])->render();
